...
const ProfileEditor: NextPage = () => {
  ...
  useEffect(() => {
    console.log(
      !Boolean(isCol) && typeof cityName !== typeof undefined && cityName !== ""
    );
    if (
      !Boolean(isCol) &&
  ...
  return (
    <Layout isLogin={true} profile={user} userId={user?.id}>
      <div className="fixed flex h-16 w-screen items-center justify-center bg-white shadow-sm">
      ...
      <div className="flex justify-center bg-slate-100 p-28">
        <div>
          <div className="flex flex-col border">
            <div className="w-72 rounded-t-sm border-l-2 border-blue-600 bg-white py-2 pl-4 text-base font-semibold text-blue-600">
              <span>기본 정보</span>
            </div>
            <div className="w-72 rounded-t-sm border-t bg-white py-2 pl-4 text-base text-black">
              <span>웹</span>
            </div>
            <div className="w-72 rounded-t-sm border-t bg-white py-2 pl-4 text-base text-black">
              <span>내 정보</span>
        ...
        <form
          ...
          className="ml-6 flex flex-col space-y-6"
        >
                ...
                <div className="flex flex-col">
                  ...
                  <div className="mt-4">
                    ...
                    >
                      ...
                      <option data-code="MP" value="Northern Mariana Islands">
                    ...
                    <datalist id="city">
                      {cityData &&
                        cityData.map((item: StatesProps) => (
                          <option key={item.code} value={item.name}></option>
                        ))}
                    </datalist>
                  </div>
                </div>
          ...
          <div className="border bg-white p-8">
            ...
            <TextArea
              ...
              maxLength={800}
            ></TextArea>
            {errors.me && <ErrorMessage>{errors.me.message}</ErrorMessage>}
          </div>
        </form>
      </div>
    </Layout>
